        ...
        <div className='min-vh-100'>
            ...
            <main className="px-3">
                ...
                <form className="row g-3">
                    ...
                    {data.tanggapan &&
                        <div className="form-floating">
                            <textarea readOnly className="form-control" value={data.tanggapan} name='tanggapan' placeholder="Leave a comment here" id="floatingTextarea3" style={{ height: 100 + 'px' }} required />
                            <label htmlFor="floatingTextarea3">Tanggapan</label>
                        </div>
                    }
